...
exposed.route('/people', {
    name: 'people',
    action() {
        BlazeLayout.render('layout1', { top: "Navbar", main: "PeopleList" });
    }
});
...
exposed.route('/brands', {
    name: 'brands',
    action() {
        BlazeLayout.render('layout1', { top: "Navbar", main: "BrandList" });
    }
});
...
exposed.route('/brand/network', {
    name: 'brandNetwork',
    action() {
        BlazeLayout.render('layout1', { top: "Navbar", main: "BrandNetwork" });
    }
});

exposed.route('/brand/favorites', {
    name: 'brandFavorites',
    action() {
        BlazeLayout.render('layout1', { top: "Navbar", main: "BrandFavorites" });
    }
});
...
exposed.route('/products', {
    name: 'products',
    action() {
        BlazeLayout.render('layout1', { top: "Navbar", main: "ProductList" });
    }
});
...
exposed.route('/campaigns', {
    name: 'campaigns',
    action() {
        BlazeLayout.render('layout1', { top: "Navbar", main: "CampaignList" });
    }
});
...
exposed.route('/academy', {
    name: 'academy',
    action() {
        BlazeLayout.render('layout1', { top: "Navbar", main: "CourseList" });
    }
});
...
exposed.route('/apps', {
    name: 'apps',
    action() {
        BlazeLayout.render('layout1', { top: "Navbar", main: "AppsList" });
    }
});
